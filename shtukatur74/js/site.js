...
window.SITE = {
  ...
  whatsapp: '79090856451',            // номер для wa.me (без +, без пробелов)
  telegram: 'imovv',                  // username Telegram без «@»
  ...
  metrikaId: '101530498',             // счётчик Яндекс.Метрики (пусто = не подключать)
  ...
  /* Формы сбора персональных данных.
     ВКЛЮЧЕНО ВРЕМЕННО, для теста конверсии — уведомление в РКН ещё не
     подано, риск принят владельцем сознательно на время эксперимента.
     Выключить обратно — false здесь и FORMS_ENABLED = false в
     api/request.php. */
  formsEnabled: true
};
