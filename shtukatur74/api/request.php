...
/**
 * Форма включена ВРЕМЕННО, для теста конверсии — уведомление в Роскомнадзор
 * об обработке ПД на этот момент не подано. Владелец сознательно принял этот
 * риск на время эксперимента (см. обсуждение штрафов по ст. 19.7/13.11 КоАП).
 * Выключать вместе с SITE.formsEnabled в js/site.js.
 */
