      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-18 py-4">
          ...
          <div className="hidden md:flex items-center gap-3">
            ...
            <a
              href="/crm/login"
              className="flex items-center gap-1.5 text-slate-300 hover:text-white border border-slate-600 hover:border-orange-400 text-sm font-medium py-2.5 px-4 rounded-lg transition-all duration-200"
            >
        ...
        {menuOpen && (
          <div className="md:hidden bg-slate-900 border-t border-slate-700 pb-4">
            ...
            <div className="px-4 pt-4 flex flex-col gap-3">
              ...
              <a
                href="/crm/login"
                className="flex items-center justify-center gap-2 text-slate-300 border border-slate-600 text-sm font-medium py-2.5 px-4 rounded-lg"
              >
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                  <rect x="3" y="11" width="18" height="11" rx="2" ry="2"/>
                  <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
